...
I made a shoe store. I chose this topic because I like shoes. I represented my store's service by using user input to get outputs. For the program to work properly and for the user to know what to do, the program will have outputs that guide the user to know what to type. Anything the user inputs is stored and later shown again as the final product. 